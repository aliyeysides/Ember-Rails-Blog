...
EmberRailsBlog.PostView = Ember.View.extend({
  ...
  didInsertElement: function () {
    if (window.DISQUS) { // Simply reload disqus
      var id = this.get("controller.model"),
      ...
      console.log("controller.model", this.get("controller.model"));
      console.log(typeof this.get("controller.model"));
      console.log("post", this.get("controller.model.id"));
      console.log("store", this.get("controller.model.store"));
